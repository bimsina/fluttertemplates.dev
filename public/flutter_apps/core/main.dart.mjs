...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1617: () => globalThis.document,
      _1619: () => globalThis.console,
      _1624: (x0,x1) => { x0.height = x1 },
      _1626: (x0,x1) => { x0.width = x1 },
      _1628: (x0,x1) => { x0.pointerEvents = x1 },
      _1637: x0 => x0.style,
      _1640: x0 => x0.src,
      _1641: (x0,x1) => { x0.src = x1 },
      _1642: x0 => x0.naturalWidth,
      _1643: x0 => x0.naturalHeight,
      _1658: (x0,x1) => x0.error(x1),
      _1663: x0 => x0.status,
      _1664: (x0,x1) => { x0.responseType = x1 },
      _1666: x0 => x0.response,
